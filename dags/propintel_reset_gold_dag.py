...
with DAG(
    'propintel_reset_gold',
    default_args=default_args,
    description='Teardown DAG: Wipes Gold zone to roll back pipeline state to Silver.',
    ...
    reset_task = BashOperator(
        ...
        bash_command='/tmp/propintel_venv/bin/python /opt/airflow/src/utils/reset_gold.py',
    )
